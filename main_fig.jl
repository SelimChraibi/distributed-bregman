...
history_sync_paper = sync_optimize(rand(m,1), paper_solver; epochs=10000, verbose=100);
...
save("./data/$file_name.jld2", "parameters", parameters, "histories", histories, "objective", objective)
